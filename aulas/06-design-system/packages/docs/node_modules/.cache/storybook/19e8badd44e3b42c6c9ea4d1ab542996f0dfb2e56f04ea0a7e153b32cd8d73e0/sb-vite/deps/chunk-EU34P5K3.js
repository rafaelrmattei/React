...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-YD7FEOPU.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-DF2HB3H2.js"), act = await getAct();
...
//# sourceMappingURL=chunk-EU34P5K3.js.map
